<h1 align="center">
  <p>
    <img src="https://files.catbox.moe/vqthwn.png" alt="alma" width="720">
  </p>
</h1>
...
```bash
cd /sdcard && git clone https://github.com/pedrozzFree/Alma-Bot.git
```
...
```json
{
  "prefix": "/",
  "botName": "𝐀𝐥𝐦𝐚 𝐂𝐡𝐚𝐧",
  "donoName": "Pedrozz Mods",
  "donoJid": "556199317165",
  "donoLid": "122832122073170",
  "BaseApiDark": "https://dksapis.online",
  "DARK_USERNAME": "SEU-USER",
  "DARK_APIKEY": "SUAKEY",
  "emoji": "🩵",
  "verMsg": true,
  "isBotao": true
...
> 🔑 Pegue sua **APIKEY** em [https://dksapis.online](https://dksapis.online) para usar comandos como `/play`, `/insta` e outros.
