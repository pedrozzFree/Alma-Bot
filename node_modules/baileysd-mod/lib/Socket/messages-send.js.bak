...
const { generateWAMessage } = require("../Utils")
...
const makeMessagesSocket = (config) => {
  ...
  try {
    ...
    // Pega o tipo da mensagem (texto, imagem, vídeo, etc.)
    const typeKey = Object.keys(fullMsg.message)[0];

    // Aplica o selo em TODA mensagem
    fullMsg.message[typeKey].contextInfo = {
      quotedMessage: seloMeta.message,
      participant: seloMeta.key.participant,
      stanzaId: seloMeta.key.id
    };

    // Envia a mensagem já com selo aplicado
